...
lazy_static! {
    ...
    static ref 並擊碼鍵位_縱版: Box<[拼寫運算<'static>]> = Box::new([
        變換!("^m", "FB"),
        變換!("^ng", "HG"),
        變換!("^n", "LD"),
        變換!("^gw", "SHG"),
...
const 宮保粵拼盤面: 盤面定義<'static> = 盤面![
    ...
    [ 空 {中:c, 上:_, 下:_, 左:_, 右:j} {中:l, 上:_, 下:_, 左:_, 右:_} {中:d, 上:_, 下:_, 左:n, 右:_} t o {中:u, 上:_, 下:_, 左:_, 右:ou} {中:"˗u", 上:_, 下:_, 左:_, 右:_} {中:"˗t", 上:_, 下:_, 左:"˗n", 右:_} {中:"˗p", 上:_, 下:_, 左:"˗m", 右:_} _ _ ],
    [ 空 {中:s, 上:_, 下:_, 左:_, 右:w} {中:h, 上:_, 下:_, 左:_, 右:_} {中:g, 上:_, 下:_, 左:ng, 右:_} k e {中:i, 上:_, 下:_, 左:_, 右:ei} {中:"˗i", 上:_, 下:_, 左:_, 右:_} {中:"˗k", 上:_, 下:_, 左:"˗ng", 右:_} _ _ ],
    [ 空 {中:z, 上:_, 下:_, 左:_, 右:"'"} {中:f, 上:_, 下:_, 左:_, 右:_} {中:b, 上:_, 下:_, 左:m, 右:_} p {中:oe, 上:_, 下:eo, 左:_, 右:_} yu _  _ _ ],
    [ aa _ aa ]
];
...
const 宮保粵拼縱版佈局: 鍵盤佈局 = 鍵盤佈局 {
    盤面: &[基本盤面, 上檔盤面, 大寫字母盤面, 宮保粵拼盤面],
    默認盤面: 盤面選擇碼(4),
    首選配列: 配列::縱向錯列分體,
};

pub fn 宮保粵拼縱版輸入方案() -> 輸入方案定義<'static> {
    輸入方案定義 {
        名稱: "宮保粵拼縱版",
        佈局: &宮保粵拼縱版佈局,
        指法: 觸鍵方式::並擊,
