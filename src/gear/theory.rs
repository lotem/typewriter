...
use crate::theory::{
    alphabet::拉丁字母輸入方案, cangjie::倉頡輸入方案,
    cangjie_luminary_chords::倉頡七曜並擊輸入方案, cantonese::粵語輸入方案,
    combo_jyutping::宮保粵拼輸入方案, combo_pinyin::宮保拼音輸入方案,
    combo_zhuyin::宮保注音輸入方案, detenele::動態能力注音輸入方案,
