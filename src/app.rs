...
const 預設練習題: [(&str, &str); 7] = [
    ...
    ("音節練習",
     "bu pu fu me de te le ne ge ke he zhi chi shi ri zi ci si a"),
    ("宮保拼音並擊術",
     "gong bao pin yin bing ji shu \
      jie zou ming kuai you zhi guan \
      yi ji yi ge zhong wen zi \
      neng fen ping qiao yu jian tuan \
      biao zhun she bei guang jian rong \
      liu jian wu chong qi zhi chan \
      su ji qian zong gui jian yi \
      yin yun wan bian lie qin pan"),
    ("題中州韻輸入法",
     "hui hao ji jian shu tu tong gui \
      wen zi jing miao ji qiao sheng hui \
      shu fa cheng shi bu dao chen gui \
      jin yin gu yun yan yi lei tui \
      ji si zhong tu xin huai zhu yi \
      die dai han shu da zao shen qi \
      dai ma bu ji zhi ling xi li \
      kai bi yuan xi si liu yong ji"),
    ("鼠鬚管",
     "zhuo jun yi jing zhou yu zhen zhi jiao \
      zeng jun yi xuan cheng shu xu zhi guan \
      jiu ru chang hong yin cang hai \
      bi ruo jun ma chi ping ban \
      ai jun shang shao li fang hao \
      jie wo jiu shuai huan jian xian \
      wen zhang jing shi zhi ming zao \
      yi qi lun jiao xiang de wan \
      yu zhen jiao \
      yi ju shi fen dang fu zhan \
      shu xu guan \
      wei wu sui wei qing bu qian \
      xin shi zui mo shi yi hui \
