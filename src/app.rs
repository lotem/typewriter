...
use crate::engine::{微觀引擎, 微觀引擎輸出信號, 視圖輸入信號};
use crate::gear::{
...
pub fn Rime打字機應用() -> impl IntoView {
    ...
    view! {
        ...
        <div class="echo-bar">
            <div title="重新錄入／選練習題">
                <Rime鍵圖
                    鍵={退出鍵.鍵碼} 標註法={標註功能鍵(退出鍵)} 着色法={開關狀態}
                    落鍵動作={視圖落鍵動作} 抬鍵動作={視圖抬鍵動作}
                />
            </div>
            <div title="下一題">
                <Rime鍵圖
                    鍵={製表鍵.鍵碼} 標註法={標註功能鍵(製表鍵)} 着色法={並擊動態}
                    落鍵動作={視圖落鍵動作} 抬鍵動作={視圖抬鍵動作}
                />
            </div>
            <Rime編碼欄
            ...
            <div title="輸入拼音反查鍵位">
                <Rime鍵圖
                    鍵={回車鍵.鍵碼} 標註法={標註功能鍵(回車鍵)} 着色法={開關狀態}
                    落鍵動作={視圖落鍵動作} 抬鍵動作={視圖抬鍵動作}
                />
            </div>
            <div title="刪除／回退一字">
                <Rime鍵圖
                    鍵={退格鍵.鍵碼} 標註法={標註功能鍵(退格鍵)} 着色法={並擊動態}
                    落鍵動作={視圖落鍵動作} 抬鍵動作={視圖抬鍵動作}
                />
            </div>
        </div>
