...
pub const 宮保拼音練習題: &[練習題] = &[
    ...
    練習題 {
        標題: "綜合練習二",
        編碼: 並擊("wan'sui jie'jue guo'cheng quan'xuan tiao'jian yuan'yin sheng'chan'xian \
    ...
    練習題 {
        標題: "綜合練習三",
        編碼: 並擊("jing'xing gong'jing jiong'jing hong'xing jing'kong kong'jing qiong'kong qiong'kun \
    ...
    練習題 {
        標題: "倉頡轉世賦",
        編碼: 並擊("cang jie gong zhuan shi \
                         qiao ZIANE=jiang chu he yin \
                         zhong zhou yun qi yan shi fan pin \
                         da dao zhi jian yi xuan ao gao shen \
                         yun yong miao fa cun hu yi SIN=xin \
                         zong CINE=qing yu lie zi hai ci lin \
                         hui bu hui mou tian chuan yue gu jin \
                         kou zhong yan yu shi hua xia zheng yin \
                         wo zen ken ZIANE=jiang zhu liu fang ren \
                         ku zhi yi nian zhong bu de SIAO=xiao sa \
                         nan yu jiang ming liao SIN=xin li zhen hua \
                         ji CINE=qing bian ma yong CIAN=qian wan ci qiao da \
                         xue hui si SIANE=xiang zai jian pan shang biao da"),
    ...
    練習題 {
        標題: "中州韻",
        編碼: 並擊("hui hao ji jian shu tu tong gui \
                         wen zi ZINE=jing miao ji qiao sheng hui \
                         shu fa cheng shi bu dao chen gui \
                         jin yin gu yun yan yi LUR=lei tui \
                         ji si zhong tu SIN=xin huai zhu yi \
    ...
    練習題 {
        標題: "鼠鬚管",
        編碼: 並擊("zhuo jun yi jing zhou yu zhen zhi ZIAO=jiao \
                         zeng jun yi SÜAN=xuan cheng shu SÜ=xu zhi guan \
                         ZIR=jiu ru chang hong yin cang hai \
                         bi ruo ZÜN=jun ma chi ping ban \
                         ai jun shang shao li fang hao \
                         ZIE=jie wo jiu shuai huan ZIAN=jian SIAN=xian \
                         wen zhang jing shi zhi ming zao \
                         yi qi lun jiao SIANE=xiang de wan \
                         yu zhen ZIAO=jiao \
                         yi ju shi fen dang fu zhan \
                         shu SÜ=xu guan \
                         wei wu sui wei CINE=qing bu CIAN=qian \
                         SIN=xin shi zui mo shi yi hui \
