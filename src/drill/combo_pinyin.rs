use super::练习题;
use crate::gear::caption::{ 字幕格式::{ 段落, 词句 }, 字幕步进::逐词 };

pub const 宫保拼音练习题: &[练习题] = &[
    练习题 {
        标题: "中州韻輸入法引擎",
        编码: "zhong zhou yun shu ru fa yin qing \
               si xiang yong jian pan biao da ye xing",
        字幕: 词句("中州韻輸入法引擎 思想用鍵盤表達也行"),
    },
    练习题 {
        标题: "東風破早梅",
        编码: "dong feng po zao mei \
               xiang nuan yi zhi kai \
               bing xue wu ren jian \
               chun cong tian shang lai",
        字幕: 词句("東風破早梅 向暖一枝開 冰雪無人見 春從天上來"),
    },
    练习题 {
        标题: "聲母韻母練習",
        编码: "b p m f d t n l \
    ...
    练习题 {
        标题: "單字練習",
        编码: "yi er san si wu liu qi ba jiu shi \
    ...
    练习题 {
        标题: "綜合練習一",
        编码: "yang'wang'xing'kong yan'jiu'jue'ding \
        ...
        字幕: 词句(
            "仰望星空 研究決定 自然選擇 徹底決裂 不斷發展 人民羣衆 \
                    注意安全 還原反應 生命財產 少校軍銜 原來如此 厚顏無恥"
        ),
    },
    练习题 {
        标题: "綜合練習二",
        编码: "wan'sui jie'jue guo'cheng quan'xuan tiao'jian yuan'yin sheng'chan'xian \
    ...
    练习题 {
        标题: "綜合練習三",
        编码: "jing'xing gong'jing jiong'jing hong'xing jing'kong kong'jing qiong'kong qiong'kun \
    ...
    练习题 {
        标题: "縮略碼示例",
        编码: "SHG=<shen me> SHGUA=<shu ru fa> ZUAO=<zui hao> \
    ...
    练习题 {
        标题: "宮保拼音並擊術",
        编码: "gong bao pin yin bing ji shu \
    ...
    练习题 {
        标题: "中州韻",
        编码: "hui hao ji jian shu tu tong gui \
    ...
    练习题 {
        标题: "鼠鬚管",
        编码: "zhuo jun yi jing zhou yu zhen zhi ziao \
